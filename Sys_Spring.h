...
private:
	...
	float calculateSpringTorque(const float& currentAngle, const float& targetAngle, const float& angularVelocity, const float& strength, const float& dampingCoeff);
};